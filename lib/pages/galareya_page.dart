...
import 'package:uyishi/widgets/galareya_widget.dart';

class GalareyaPage extends StatefulWidget {
  const GalareyaPage({super.key});

  @override
  State<GalareyaPage> createState() => _GalareyaPageState();
}

class _GalareyaPageState extends State<GalareyaPage> {
  @override
